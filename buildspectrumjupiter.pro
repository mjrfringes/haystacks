; Build Jupiter Spectrum - 2014-10-07
; Aki Roberge
...
; ##### Near-IR #####
  ...
  rangeo = where((powl gt 0.910) and (powl lt 0.960))
  rangei = where((piwl gt 0.910) and (piwl lt 0.960))
...
; ##### Total #####
  ...
  ; Patch over NIR gap with a Burrows 4 AU Jupiter model.
  
  readcol,'~/Other_Projects/Haystacks/Planet_Spectra/Burrows/jup_4.0AU.txt', $ 
	w_b,f_b,ref_b
	
  rangeb = [1.8127,1.8732]
  sclb = 2.85d8
 ...
 ; Save spectrum files and plot
  save,filename=spec_final_dir+planet+'_geo_albedo.sav',pwl,palb
