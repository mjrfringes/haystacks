; Build Earth Spectrum - 2014-07-30
; Andrew Lincowski
...
; File structure and load files
  ...
  pl_file = 'earth_quadrature_radiance_refl.dat'     

  ; Planet spectrum: wavelength in um, pref is the 'reflectance' at quadrature  
  readcol,spec_input_dir+pl_dir+pl_file,pwl,pint,psol,pref 
  	
  ; Convert reflectance at quadrature to geometric albedo.
