; Build Saturn Spectrum - 2014-10-07
; Aki Roberge
...
; ##### Near-IR #####
  ...
  rangeo = where((powl gt 0.955) and (powl lt 0.960))
  rangei = where((piwl gt 0.955) and (piwl lt 0.960))
  ...
  readcol,'~/Other_Projects/Haystacks/Planet_Spectra/Burrows/jup_10AU.txt', $ 
	w_b,f_b,ref_b
	
  rangeb = [1.8180,1.8805]
  sclb = 4.55d9
